...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/bURvW6NA9c)
...
```sh
npx nx serve recipe-search-ui-playground
```

To create a production bundle:

```sh
npx nx build recipe-search-ui-playground
```

To see all available targets to run for a project, run:

```sh
npx nx show project recipe-search-ui-playground
```
